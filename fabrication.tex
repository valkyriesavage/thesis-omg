...
A ``single sensor'' can take many forms. \valkyrie{if we are grouping by machine, maybe we want to group by technique here rather than the simple/moderate/sophisticated nonsense.}
