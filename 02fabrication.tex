...
\caption{The range of objects produceable via digital fabrication is huge: from 2D images on paper (left, David Mellis on Flickr, from \url{https://www.flickr.com/photos/mellis/5298037920/}, \ccby) \valkyrie{swap out this image!}, to 3D projections of 4D objects (right, Bathsheba Grossman of Bathsheba Sculpture LLC, from \url{http://bathsheba.com/math/klein/klein_Abeer.jpg}, by permission).}
\label{fig:range}
\end{figure}
