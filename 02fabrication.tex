...
%\valkyrie{You can just, I guess, give a short definition of what each of these properties are, and then refer to that properties table..}
...
\subsection{Principles}
    ...
    \begin{itemize}
      ...
      \item for geometry: \begin{itemize}
        ...
        \item geometry needs to make it possible for a given type of signal to reach every part of an object without collision. For example, an ultrasonic rangefinder cannot "see across" a 2D fabricated object (as everything is on the same plane). \valkyrie{still chewing on this one...}
        \end{itemize}
...
\subsection{The Most Promising Overlaps}
    ...
    \valkyrie{choose a few things outside this thesis that we think are the best places to look next? maybe?}
