...
\caption{FFF machines can lay plastic to create a variety of material compositions, ranging from hollow to sparse to solid. Here, we see a variety of compositions, arranged in order of percent(material/air) (Thingiverse user CreativeTools, from \url{http://www.thingiverse.com/thing:85711}, CC BY)}
...
\caption{The range of objects produceable via digital fabrication is huge: from 2D images on paper (left, David Mellis on Flickr, from \url{https://www.flickr.com/photos/mellis/5298037920/}, CC BY) \valkyrie{swap out this image!}, to 3D projections of 4D objects (right, Bathsheba on Shapeways, from \url{http://www.shapeways.com/product/LR5J593S8/klein-bottle-opener}, by permission).}
\label{fig:range}
\end{figure}
